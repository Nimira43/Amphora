  ...
  return (
    <div className='max-w-7xl mx-auto px-4 py-12'>
      <div className='flex flex-col md:flex-row bg-light rounded-2xl overflow-hidden shadow-lg'>
        <div className='md:w-1/2 bg-grey-light-extra p-8 centre relative'>
        ...
        <div className='md:w-1/2 p-8 md:p-12 space-y-6'>
          <div>
            ...
            <p className='text-grey-dark'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eos et reprehenderit placeat.</p>
          </div>
